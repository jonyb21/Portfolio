...
assert(electricPumpImages.every(image => /^\/assets\/mobility\/gauge-electric-pump-[a-z-]+-photo-v[45]\.webp$/.test(image)), "The electric pump uses one corrected versioned gallery");
...
assert(electricPumpHumanView.label === "Human-operated inflation at dusk" && electricPumpHumanView.image.endsWith("context-active-photo-v5.webp"), "The pump includes a human operating its intake-lit valve connection");
...
assert(localAssetHash("/assets/mobility/gauge-electric-pump-context-active-photo-v5.webp") === "a717fec29e0f31bcc6d1d2b8e686e942a556862c236c834ac33e1eca04ac199d", "The pump dusk view preserves the approved human-operated intake light");
