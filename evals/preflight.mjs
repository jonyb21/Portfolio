...
assert(css.includes("--media-ratio: 4 / 3") && css.includes("object-fit: contain"), "All portfolio photos use one uncropped 4:3 presentation");
assert([index, work, product, about, contact].every(page => page.includes("/styles.css?v=20260710-5")), "Every public page loads the current media framing styles");
...
assert(ridgeProject.cardImage === "/assets/furniture/ridge-four-leg-main.webp", "Ridge dining table uses the new four-legged product render");
